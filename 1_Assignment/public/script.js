...
// function to open a new tab with the image
// working well in mozilla but in chrome it open a new tab with a html of the image
// you have to open the image link in another tab to download it. 
function opentab(){
